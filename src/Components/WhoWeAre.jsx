...
function WhoWeAre() {
    return (
        <div className="flex justify-between py-20 bg-gradient-to-b from-white via-yellow-200 to-yellow-200">
            <div className="mx-20 py-28 flex flex-col gap-5 w-[40rem]">
                ...
                <button className="mt-8 py-2 w-[8rem] text-xl font-semibold rounded-full bg-transparent border border-orange-500 text-black hover:bg-orange-400">Learn</button>
            </div>
            <div className="px-10">
